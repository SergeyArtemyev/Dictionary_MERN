...
import NoWordsFound from '../dictionary/layout/skeleton/NoWordsFound';
  ...
  return (
    <Fragment>
      {!loading && words.length !== 0 ? (
        <>
    <div id='hangman' data-target='Hangman' className='game flex-column justify-content-center align-items-center'>
      <h1>Hangman</h1>
      <p>Translate the word  - <span className='hang-word'></span></p>
